...
inputService = Blueprint("input_service", __name__)


@inputService.route("/msg", methods=["GET", "POST"])
def receiveMsg():
...
@inputService.route("/createRecipe")
def create():
    """[summary]
